...
class OrderSummarySheet extends StatelessWidget {
    ...
    bool? confirm = await showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('Are you sure you want to cancel the order summary? This will delete it.'),
          actions: <Widget>[
            TextButton(
  ...
  Future<void> _proceedToPayment(BuildContext context) async {
    ...
    int amount = (totalPrice * 100).toInt(); // Convert to the smallest currency unit
    ...
    try {
      ...
      if (userData != null) {
        ...
        if (userLocation != null) {
          ...
          List<String> pharmacyNames = pharmacyDetails.values.map((details) => details['name'] as String).toList();
          List<String> pharmacyAddresses = pharmacyDetails.values.map((details) => details['address'] as String).toList();
          ...
          try {
            await FirebaseFirestore.instance.collection('notifications').add({
              ...
              'userId': userId,
              'orderItems': groupedOrderItems.values.expand((items) => items).toList(),
              'orderStatus': 'pending',
              'timestamp': FieldValue.serverTimestamp(),
          ...
          Row(
            ...
            children: [
              IconButton(
                ...
                onPressed: () => _confirmCancel(context), // Show confirmation dialog
              ),
              Text(
                'Order Summary',
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 20),
                    ElevatedButton(
                      onPressed: () => _proceedToPayment(context), // Proceed to payment
